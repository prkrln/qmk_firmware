...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_QT_GRV] = ACTION_TAP_DANCE_DOUBLE(KC_QUOT, KC_GRV),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_ortho_3x10(
        ...
        LT(1, KC_SPC), LT(1, KC_ENT)
    ),
    [1] = LAYOUT_ortho_3x10(
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        MT(MOD_LGUI, KC_LBRC),    MT(MOD_LALT, KC_RBRC),    MT(MOD_LSFT, TD(TD_QT_GRV)),    MT(MOD_LCTL, KC_MINS),    KC_EQL,    KC_LEFT,    MT(MOD_RCTL, KC_DOWN),    MT(MOD_RSFT, KC_UP),    MT(MOD_RALT, KC_RGHT),    MT(MOD_RGUI, KC_TAB),
